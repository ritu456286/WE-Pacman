...
class Block(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y):
        ...
        # Load the dot image and resize it to 4x4 pixels
...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, filename):
        ...
        # Resize Pacman to 30x30 pixels (same as ghosts)
...
pygame.display.set_caption('Anshul\'s Adventure')
...
def startGame():
    ...
    for row in range(19):
        for column in range(19):
            if (row == 7 or row == 8) and (column == 8 or column == 9 or column == 10):
                ...
                block = Block((30 * column + 6) + 26, (30 * row + 6) + 26)
    ...
    while done == False:
        ...
        if score == bll:
            ...
            win_sound.play()
            doNext("Game Won!", 145, all_sprites_list, block_list, monsta_list, pacman_collide, wall_list, gate)
